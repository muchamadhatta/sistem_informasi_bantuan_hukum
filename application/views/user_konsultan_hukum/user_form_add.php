			...
			<form role="form" action="" method="post">
				<div class="card-body">
					...
					<div class="form-group">
						...
						<input type="text" name="spesialisasi" value="<?=set_value('spesialisasi')?>"
					...
					<div class="form-group">
						...
						<input type="text" name="pengalaman" value="<?=set_value('pengalaman')?>" class="form-control"
					...
					<div class="form-group">
						...
						<input type="text" name="kampus" value="<?=set_value('kampus')?>" class="form-control"
					...
					<div class="form-group">
						...
						<input type="text" name="keahlian" value="<?=set_value('keahlian')?>" class="form-control"
					...
					<div class="form-group">
						...
						<select name="level" class="form-control">
							<option value="konsultan_hukum"
								<?=set_value('level') == 'konsultan_hukum' ? "selected" : null?>>Konsultan Hukum
							</option>
						</select>
						<?=form_error('level')?>
					</div>
