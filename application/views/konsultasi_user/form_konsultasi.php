...
<?php $this->view('massages')  ?>
	...
	<div class="col col-md-12">
		...
		<div class="card card-success">
			...
			<!-- /.card-header -->
			<!-- form start -->
			<?php echo form_open_multipart('konsultasi_klien/process') ?>
				<div class="card-body">
					...
					<div class="form-group">
						...
						<textarea type="text" name="masalah_kasus" rows="4"  class="form-control"
					...
					<div class="form-group">
						...
						<textarea type="text" name="penanganan"  class="form-control"
