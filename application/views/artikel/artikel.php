			...
			<table class="table table-striped" id="table1">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<img src="<?=base_url('uploads/artikel/'.$data->image)?>" style="width:100px">

						</td>
						<td>
							<form action="<?=site_url('artikel/del/')?>" method="post">
								<ul class="fc-color-picker">
									<li><a class="btn btn-success btn-xs" data-toggle="tooltip" title="Read"
											href="<?=site_url('artikel/read/'.$data->id_artikel)?>"><i
												class="fa fa-eye"></i></a></li>
									<li><a class="btn btn-primary btn-xs" data-toggle="tooltip" title="Update"
											href="<?=site_url('artikel/update/'.$data->id_artikel)?>"><i
